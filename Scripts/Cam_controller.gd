...
func _physics_process(delta):
	global_position = lerp(global_position, active_camera_mount.global_position, 0.08)
	global_rotation = lerp(global_rotation, active_camera_mount.global_rotation, 0.08)
